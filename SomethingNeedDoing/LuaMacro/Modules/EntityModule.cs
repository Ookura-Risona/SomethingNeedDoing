...
public unsafe class EntityModule : LuaModuleBase
{
    ...
    [LuaFunction] public EntityWrapper? NearestOtherCharacter => Svc.Objects.OfType<IPlayerCharacter>().OrderBy(ECommons.GameHelpers.Player.DistanceTo).FirstOrDefault(o => o.EntityId != Player.GameObject->EntityId) is { } obj ? new(obj) : null;
